...
<div class="container">
	...
	<div class="row justify-content-center border-round">
                        <div class="col-12 col-md-10 col-lg-8">
                            <form action="./modal/booksearch.php" method="get" class="card card-sm bg-transparent border-0">
                                <div class="card-body border-round row no-gutters align-items-center card-color">
                                    <!--end of col-->
                                    <div class="col">
                                    <input class="form-control form-control-lg form-control-borderless border-round" type="text" placeholder="Book Title">
                                    </div>
                                    <!--end of col-->
